...
const portfolioData = {
  ...
  about: {
    ...
    highlights: [
      ...
      "Published research on automated application testing using deep learning",
      "Full-cycle development across payment systems, microservices & cloud infrastructure",
    ],
    focus: [
    ...
    positions: [
      {
        ...
        highlights: [
          ...
          "Delivered full-cycle development across frontend and backend, including API integrations and business logic",
          "Collaborated with cross-functional teams to enhance platform performance, reliability, and user experience",
        ],
        featured: true,
        visible: true,
        icon: "/company-logo/sheba.webp",
      },
      {
      ...
      },
      {
        ...
        highlights: [
          ...
          "Worked on in-house security projects",
        ],
        featured: false,
        visible: false,
        showInSeeMore: true,
        icon: "/company-logo/aws.webp",
      },
    ],
  },
  projects: {
        ...
        projects: [
          {
            ...
            features: [
              ...
              "Host meetings with only allowed attendees",
            ...
            liveLink: "https://timeforge.vercel.app/",
            featured: true,
            visible: true,
          },
          {
            ...
            features: [
              ...
              "Salon owner dashboard for managing appointments and services",
        ...
        projects: [
          {
            ...
            githubLink: {
              Repository: "https://github.com/434huzaifa/EduSphere",
            },
            liveLink: "https://edu-sphere-yqk2.vercel.app/",
            featured: false,
            visible: true,
          },
          {
          ...
          },
          {
            ...
            features: [
              ...
              "Track company device assignments",
              "Simple CRUD operations on data",
            ],
            githubLink: {
              Client: "https://github.com/434huzaifa/AssetTrackr-Frontend",
              Server: "https://github.com/434huzaifa/AssetTrackr-backend",
            },
            liveLink: "https://asset-trackr-frontend-mauve.vercel.app/login",
            featured: false,
            visible: true,
            showInSeeMore: true,
          },
          {
            ...
            features: [
              "Staff and carer management with profile images",
              "Booking scheduler with one-time and recurring shifts",
              "Monthly calendar view with color-coded shifts",
              "Automatic conflict detection and prevention",
              "RRule generator for complex recurrence patterns",
              "Real-time pricing calculation and special instructions",
            ],
            githubLink: {
              Repository: "https://github.com/434huzaifa/shift-care",
            },
            featured: true,
            liveLink: "https://shift-care-vert.vercel.app",
            visible: true,
          },
          {
            name: "RestroHub",
            ...
            features: [
              "Modular RESTful APIs using Django-Ninja and Django-Ninja-Extra",
              "Stripe payments secured with JWT-based authentication",
              "SQLite3 persistence with Pipenv-managed environment and Swagger UI docs",
            ],
            githubLink: {
              Repository: "https://github.com/434huzaifa/RestroHub",
            },
            featured: false,
            visible: false,
          },
  ...
  awards: {
    ...
    items: [
      {
        title: "FinTech Start-Up of the Year 2025",
        organization: "3rd Bangladesh Fintech Awards",
        description: "Core developer of Sheba Pay, the winning platform",
        date: "2025",
        featured: true,
      },
      {
        title: "FinTech Innovation of the Year (NBFI) - Honorable Mention",
        organization: "3rd Bangladesh Fintech Awards",
        description: "Backend developer for PSP Passthrough module",
        date: "2025",
        featured: true,
      },
      {
  ...
  contact: {
    ...
    socialLinks: {
      ...
      linkedin: {
        url: "https://linkedin.com/in/md-huzaifa",
        label: "LinkedIn",
      },
      email: {
        url: "mailto:saadhuzaifa2497@gmail.com",
        label: "Email",
      },
    },
