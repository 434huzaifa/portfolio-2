...
const blogPosts: BlogPost[] = [
  {
    ...
    description: 'A quick-start primer on RRule with a live tester link to craft and validate recurring schedules fast.',
  ...
  },
  {
    ...
    description: 'What I learned shipping the Vibe Coding Fake Wallet project: onboarding, security cues, and delight for builders.',
    publishDate: '2026-01-04',
    readTime: '3 min read',
    ...
    <main className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Articles on software engineering, web development, and modern technologies
        </p>
      </div>
