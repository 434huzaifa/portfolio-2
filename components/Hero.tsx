        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-7xl mx-auto">
          ...
          <div className="bento-card">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-xs text-text-tertiary font-medium">🔗 Connect</span>
            </div>
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-xs font-medium text-text-secondary">Resume</span>
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-2 bento-card">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-xs text-text-tertiary font-medium">💼 Tech Stack</span>
            </div>
          ...
          <div className="bento-card flex flex-col gap-3">
            ...
            <a href={hero.cta.secondary.link} className="btn btn-secondary w-full">
